M:fr_init
F:G$initSetupHardware$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LinitSetupHardware$ucOriginalSFRPage$1$1({1}SC:U),R,0,0,[r2]
F:G$initSetupSystemClock$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:LinitSetupSystemClock$usWait$1$1({2}SI:U),B,1,1
S:LinitSetupSystemClock$usWaitTime$1$1({2}SI:U),R,0,0,[]
S:LinitSetupSystemClock$ucOriginalSFRPage$1$1({1}SC:U),R,0,0,[r2]
T:Ffr_init$xLIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0$0({3}DG,SV:S),Z,0,0)]
T:Ffr_init$xLIST[({0}S:S$uxNumberOfItems$0$0({1}SC:U),Z,0,0)({1}S:S$pxIndex$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({4}S:S$xListEnd$0$0({8}STxMINI_LIST_ITEM:S),Z,0,0)]
T:Ffr_init$xMINI_LIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)]
T:Ffr_init$xTIME_OUT[({0}S:S$xOverflowCount$0$0({1}SC:S),Z,0,0)({1}S:S$xTimeOnEntering$0$0({2}SI:U),Z,0,0)]
