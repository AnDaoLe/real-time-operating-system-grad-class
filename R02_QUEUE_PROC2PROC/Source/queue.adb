M:queue
F:G$xQueueCreate$0$0({2}DF,DG,STQueueDefinition:S),Z,0,4,0,0,0
S:LxQueueCreate$uxItemSize$1$1({1}SC:U),B,1,-3
S:LxQueueCreate$uxQueueLength$1$1({1}SC:U),B,1,1
S:LxQueueCreate$pxNewQueue$1$1({3}DG,STQueueDefinition:S),B,1,2
S:LxQueueCreate$xQueueSizeInBytes$1$1({2}SI:U),R,0,0,[r2,r3]
S:LxQueueCreate$sloc0$1$0({3}DG,DG,SC:S),B,1,5
S:LxQueueCreate$sloc1$1$0({2}SI:S),B,1,8
F:G$xQueueGenericSend$0$0({2}DF,SC:S),Z,0,4,0,0,0
S:LxQueueGenericSend$pvItemToQueue$1$1({3}DG,SV:S),B,1,-5
S:LxQueueGenericSend$xTicksToWait$1$1({2}SI:U),B,1,-7
S:LxQueueGenericSend$xCopyPosition$1$1({1}SC:S),B,1,-8
S:LxQueueGenericSend$pxQueue$1$1({3}DG,STQueueDefinition:S),B,1,1
S:LxQueueGenericSend$xReturn$1$1({1}SC:S),B,1,4
S:LxQueueGenericSend$xTimeOut$1$1({3}STxTIME_OUT:S),B,1,5
S:LxQueueGenericSend$sloc0$1$0({3}DG,SC:S),B,1,8
F:G$xQueueGenericSendFromISR$0$0({2}DF,SC:S),Z,0,3,0,0,0
S:LxQueueGenericSendFromISR$pvItemToQueue$1$1({3}DG,SV:S),B,1,-5
S:LxQueueGenericSendFromISR$pxHigherPriorityTaskWoken$1$1({3}DG,SC:S),B,1,-8
S:LxQueueGenericSendFromISR$xCopyPosition$1$1({1}SC:S),B,1,-9
S:LxQueueGenericSendFromISR$pxQueue$1$1({3}DG,STQueueDefinition:S),B,1,1
S:LxQueueGenericSendFromISR$xReturn$1$1({1}SC:S),R,0,0,[r2]
S:LxQueueGenericSendFromISR$uxSavedInterruptStatus$1$1({1}SC:U),R,0,0,[]
S:LxQueueGenericSendFromISR$sloc0$1$0({3}DG,SC:U),B,1,4
F:G$xQueueGenericReceive$0$0({2}DF,SC:S),Z,0,4,0,0,0
S:LxQueueGenericReceive$pvBuffer$1$1({3}DG,SV:S),B,1,-5
S:LxQueueGenericReceive$xTicksToWait$1$1({2}SI:U),B,1,-7
S:LxQueueGenericReceive$xJustPeeking$1$1({1}SC:S),B,1,-8
S:LxQueueGenericReceive$pxQueue$1$1({3}DG,STQueueDefinition:S),B,1,1
S:LxQueueGenericReceive$xReturn$1$1({1}SC:S),B,1,4
S:LxQueueGenericReceive$xTimeOut$1$1({3}STxTIME_OUT:S),B,1,5
S:LxQueueGenericReceive$pcOriginalReadPosition$1$1({3}DG,SC:S),R,0,0,[r5,r6,r7]
S:LxQueueGenericReceive$sloc0$1$0({3}DG,SC:U),B,1,11
F:G$xQueueReceiveFromISR$0$0({2}DF,SC:S),Z,0,3,0,0,0
S:LxQueueReceiveFromISR$pvBuffer$1$1({3}DG,SV:S),B,1,-5
S:LxQueueReceiveFromISR$pxTaskWoken$1$1({3}DG,SC:S),B,1,-8
S:LxQueueReceiveFromISR$pxQueue$1$1({3}DG,STQueueDefinition:S),B,1,1
S:LxQueueReceiveFromISR$xReturn$1$1({1}SC:S),R,0,0,[r2]
S:LxQueueReceiveFromISR$uxSavedInterruptStatus$1$1({1}SC:U),R,0,0,[]
S:LxQueueReceiveFromISR$sloc0$1$0({3}DG,SC:U),B,1,4
F:G$uxQueueMessagesWaiting$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:LuxQueueMessagesWaiting$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LuxQueueMessagesWaiting$uxReturn$1$1({1}SC:U),R,0,0,[r2]
F:G$uxQueueMessagesWaitingFromISR$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:LuxQueueMessagesWaitingFromISR$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LuxQueueMessagesWaitingFromISR$uxReturn$1$1({1}SC:U),R,0,0,[r2]
F:G$vQueueDelete$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LvQueueDelete$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
F:Fqueue$prvCopyDataToQueue$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:LprvCopyDataToQueue$pvItemToQueue$1$1({3}DG,SV:S),B,1,-5
S:LprvCopyDataToQueue$xPosition$1$1({1}SC:S),B,1,-6
S:LprvCopyDataToQueue$pxQueue$1$1({3}DG,STQueueDefinition:S),B,1,1
S:LprvCopyDataToQueue$sloc0$1$0({1}SC:U),B,1,4
S:LprvCopyDataToQueue$sloc1$1$0({3}DG,DG,SC:S),B,1,4
S:LprvCopyDataToQueue$sloc2$1$0({2}SI:U),B,1,7
S:LprvCopyDataToQueue$sloc3$1$0({3}DG,SC:S),B,1,9
F:Fqueue$prvCopyDataFromQueue$0$0({2}DF,SV:S),Z,0,3,0,0,0
S:LprvCopyDataFromQueue$pvBuffer$1$1({3}DG,SV:S),B,1,-5
S:LprvCopyDataFromQueue$pxQueue$1$1({3}DG,STQueueDefinition:S),B,1,1
S:LprvCopyDataFromQueue$sloc0$1$0({3}DG,DG,SC:S),B,1,4
S:LprvCopyDataFromQueue$sloc1$1$0({1}SC:U),B,1,7
F:Fqueue$prvUnlockQueue$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LprvUnlockQueue$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
F:Fqueue$prvIsQueueEmpty$0$0({2}DF,SC:S),Z,0,0,0,0,0
S:LprvIsQueueEmpty$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LprvIsQueueEmpty$xReturn$1$1({1}SC:S),R,0,0,[r2]
F:G$xQueueIsQueueEmptyFromISR$0$0({2}DF,SC:S),Z,0,0,0,0,0
S:LxQueueIsQueueEmptyFromISR$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LxQueueIsQueueEmptyFromISR$xReturn$1$1({1}SC:S),R,0,0,[r2]
F:Fqueue$prvIsQueueFull$0$0({2}DF,SC:S),Z,0,0,0,0,0
S:LprvIsQueueFull$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LprvIsQueueFull$xReturn$1$1({1}SC:S),R,0,0,[r5]
F:G$xQueueIsQueueFullFromISR$0$0({2}DF,SC:S),Z,0,0,0,0,0
S:LxQueueIsQueueFullFromISR$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LxQueueIsQueueFullFromISR$xReturn$1$1({1}SC:S),R,0,0,[r5]
T:Fqueue$QueueDefinition[({0}S:S$pcHead$0$0({3}DG,SC:S),Z,0,0)({3}S:S$pcTail$0$0({3}DG,SC:S),Z,0,0)({6}S:S$pcWriteTo$0$0({3}DG,SC:S),Z,0,0)({9}S:S$pcReadFrom$0$0({3}DG,SC:S),Z,0,0)({12}S:S$xTasksWaitingToSend$0$0({12}STxLIST:S),Z,0,0)({24}S:S$xTasksWaitingToReceive$0$0({12}STxLIST:S),Z,0,0)({36}S:S$uxMessagesWaiting$0$0({1}SC:U),Z,0,0)({37}S:S$uxLength$0$0({1}SC:U),Z,0,0)({38}S:S$uxItemSize$0$0({1}SC:U),Z,0,0)({39}S:S$xRxLock$0$0({1}SC:S),Z,0,0)({40}S:S$xTxLock$0$0({1}SC:S),Z,0,0)]
T:Fqueue$xLIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0$0({3}DG,SV:S),Z,0,0)]
T:Fqueue$corCoRoutineControlBlock[({0}S:S$pxCoRoutineFunction$0$0({2}DC,DF,SV:S),Z,0,0)({2}S:S$xGenericListItem$0$0({14}STxLIST_ITEM:S),Z,0,0)({16}S:S$xEventListItem$0$0({14}STxLIST_ITEM:S),Z,0,0)({30}S:S$uxPriority$0$0({1}SC:U),Z,0,0)({31}S:S$uxIndex$0$0({1}SC:U),Z,0,0)({32}S:S$uxState$0$0({2}SI:U),Z,0,0)]
T:Fqueue$xLIST[({0}S:S$uxNumberOfItems$0$0({1}SC:U),Z,0,0)({1}S:S$pxIndex$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({4}S:S$xListEnd$0$0({8}STxMINI_LIST_ITEM:S),Z,0,0)]
T:Fqueue$xMINI_LIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)]
T:Fqueue$xTIME_OUT[({0}S:S$xOverflowCount$0$0({1}SC:S),Z,0,0)({1}S:S$xTimeOnEntering$0$0({2}SI:U),Z,0,0)]
...
S:G$xTaskCreate$0$0({2}DF,SC:S),C,0,0
...
S:G$xTaskRemoveFromEventList$0$0({2}DF,SC:S),C,0,0
...
S:G$vTaskSetTimeOutState$0$0({2}DF,SV:S),C,0,0
S:G$xTaskCheckForTimeOut$0$0({2}DF,SC:S),C,0,0
S:G$vTaskMissedYield$0$0({2}DF,SV:S),C,0,0
...
S:G$xCoRoutineCreate$0$0({2}DF,SC:S),C,0,0
S:G$vCoRoutineSchedule$0$0({2}DF,SV:S),C,0,0
S:G$vCoRoutineAddToDelayedList$0$0({2}DF,SV:S),C,0,0
S:G$xCoRoutineRemoveFromEventList$0$0({2}DF,SC:S),C,0,0
S:G$xQueueCreateMutex$0$0({2}DF,DG,STQueueDefinition:S),C,0,0
S:G$xQueueCreateCountingSemaphore$0$0({2}DF,DG,STQueueDefinition:S),C,0,0
S:G$xQueueTakeMutexRecursive$0$0({2}DF,SC:S),C,0,0
S:G$xQueueGiveMutexRecursive$0$0({2}DF,SC:S),C,0,0
S:G$xQueueAltGenericSend$0$0({2}DF,SC:S),C,0,0
S:G$xQueueAltGenericReceive$0$0({2}DF,SC:S),C,0,0
