...
S:LpxPortInitialiseStack$pxTopOfStack$1$1({3}DG,SC:U),B,1,1
S:LpxPortInitialiseStack$ulAddress$1$1({4}SL:U),R,0,0,[r5,r6,r7,r2]
S:LpxPortInitialiseStack$pxStartOfStack$1$1({3}DG,SC:U),B,1,4
F:G$xPortStartScheduler$0$0({2}DF,SC:S),Z,0,0,0,0,0
...
F:Fport$prvSetupTimerInterrupt$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LprvSetupTimerInterrupt$ucOriginalSFRPage$1$1({1}SC:U),R,0,0,[r2]
...
T:Fport$xLIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0$0({3}DG,SV:S),Z,0,0)]
T:Fport$xLIST[({0}S:S$uxNumberOfItems$0$0({1}SC:U),Z,0,0)({1}S:S$pxIndex$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({4}S:S$xListEnd$0$0({8}STxMINI_LIST_ITEM:S),Z,0,0)]
T:Fport$xMINI_LIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)]
T:Fport$xTIME_OUT[({0}S:S$xOverflowCount$0$0({1}SC:S),Z,0,0)({1}S:S$xTimeOnEntering$0$0({2}SI:U),Z,0,0)]
S:Fport$ucStackBytes$0$0({1}SC:U),E,0,0
S:Fport$pxXRAMStack$0$0({2}DX,SC:U),E,0,0
S:Fport$pxRAMStack$0$0({1}DD,SC:U),E,0,0
