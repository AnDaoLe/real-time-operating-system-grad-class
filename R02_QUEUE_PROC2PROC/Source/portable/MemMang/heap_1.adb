...
S:LpvPortMalloc$xWantedSize$1$1({2}SI:U),B,1,1
...
T:Fheap_1$xRTOS_HEAP[({0}S:S$ulDummy$0$0({4}SL:U),Z,0,0)({4}S:S$ucHeap$0$0({6144}DA6144,SC:U),Z,0,0)]
T:Fheap_1$xLIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0$0({3}DG,SV:S),Z,0,0)]
T:Fheap_1$xLIST[({0}S:S$uxNumberOfItems$0$0({1}SC:U),Z,0,0)({1}S:S$pxIndex$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({4}S:S$xListEnd$0$0({8}STxMINI_LIST_ITEM:S),Z,0,0)]
T:Fheap_1$xMINI_LIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)]
T:Fheap_1$xTIME_OUT[({0}S:S$xOverflowCount$0$0({1}SC:S),Z,0,0)({1}S:S$xTimeOnEntering$0$0({2}SI:U),Z,0,0)]
S:Fheap_1$xHeap$0$0({6148}STxRTOS_HEAP:S),F,0,0
S:Fheap_1$xNextFreeByte$0$0({2}SI:U),F,0,0
...
S:Fheap_1$__xinit_xNextFreeByte$0$0({2}SI:U),C,0,0
