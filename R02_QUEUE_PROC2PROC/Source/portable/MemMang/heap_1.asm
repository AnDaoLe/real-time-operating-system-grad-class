...
;------------------------------------------------------------
;xWantedSize               Allocated to stack - offset 1
;pvReturn                  Allocated to registers r4 r5 r6 
;sloc0                     Allocated to stack - offset 3
;------------------------------------------------------------
	G$pvPortMalloc$0$0 ==.
	C$heap_1.c$108$0$0 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:108: void *pvPortMalloc( size_t xWantedSize )
;	-----------------------------------------
...
_pvPortMalloc:
	...
	inc	sp
	C$heap_1.c$110$1$1 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:110: void *pvReturn = NULL; 
	mov	r4,#0x00
	mov	r5,#0x00
	mov	r6,#0x00
	C$heap_1.c$121$1$1 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:121: vTaskSuspendAll();
	push	ar4
	push	ar5
	push	ar6
	...
	pop	ar4
	C$heap_1.c$124$2$2 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:124: if( ( ( xNextFreeByte + xWantedSize ) < configTOTAL_HEAP_SIZE ) &&
...
00108$:
	C$heap_1.c$125$2$2 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:125: ( ( xNextFreeByte + xWantedSize ) > xNextFreeByte )	)/* Check for overflow. */
	mov	r0,_bp
	inc	r0
	inc	r0
	inc	r0
...
00109$:
	C$heap_1.c$129$3$3 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:129: pvReturn = &( xHeap.ucHeap[ xNextFreeByte ] );
	mov	r0,_bp
	inc	r0
	inc	r0
	inc	r0
	...
	mov	r6,#0x00
	C$heap_1.c$130$3$3 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:130: xNextFreeByte += xWantedSize;			
	mov	r0,_bp
	inc	r0
	inc	r0
	inc	r0
...
00102$:
	C$heap_1.c$133$1$1 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:133: xTaskResumeAll();
	push	ar4
	push	ar5
	push	ar6
	...
	pop	ar4
	C$heap_1.c$135$1$1 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:135: return pvReturn;
	mov	dpl,r4
	mov	dph,r5
	mov	b,r6
00104$:
...
;------------------------------------------------------------
	G$vPortFree$0$0 ==.
	C$heap_1.c$139$1$1 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:139: void vPortFree( void *pv )
;	-----------------------------------------
;	 function vPortFree
;	-----------------------------------------
_vPortFree:
	C$heap_1.c$144$1$1 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:144: ( void ) pv;
00101$:
	C$heap_1.c$145$1$1 ==.
	XG$vPortFree$0$0 ==.
	ret
...
;------------------------------------------------------------
	...
	C$heap_1.c$148$1$1 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:148: void vPortInitialiseBlocks( void )
;	-----------------------------------------
;	 function vPortInitialiseBlocks
;	-----------------------------------------
_vPortInitialiseBlocks:
	C$heap_1.c$151$1$1 ==.
;	C:\Users\anle\Desktop\R02_QUEUE_PROC2PROC\Source\portable\MemMang\heap_1.c:151: xNextFreeByte = ( size_t ) 0;
	mov	dptr,#_xNextFreeByte
	clr	a
	movx	@dptr,a
	inc	dptr
...
00101$:
	...
	.area CONST   (CODE)
	.area XINIT   (CODE)
Fheap_1$__xinit_xNextFreeByte$0$0 == .
