...
F:G$UART_Quit$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ready_getchar$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$ready_putchar$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$getchar$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$putchar$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LUART_Init$baudrate$1$1({4}SL:U),E,0,0
S:LUART_Init$sysclk$1$1({4}SL:U),E,0,0
S:LUART_Init$SFRPAGE_SAVE$1$1({1}SC:S),E,0,0
S:LUART_Init$sysclkoverbaud$1$1({4}SL:U),R,0,0,[r7,r0,r1,r6]
...
S:G$gets_safe$0$0({2}DF,DG,SC:S),C,0,0
