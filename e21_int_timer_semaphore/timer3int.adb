M:timer3int
F:G$Timer3_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer3_ResetSemaphore$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer3_GetSemaphore$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$Timer3_ISR$0$0({2}DF,SV:S),Z,0,0,1,14,0
F:G$Timer3_ISR$0$0({2}DF,SV:S),Z,0,0,1,14,0
F:G$Timer3_ISR$0$0({2}DF,SV:S),Z,0,0,1,14,0
F:G$Timer3_ISR$0$0({2}DF,SV:S),Z,0,0,1,14,0
S:Ftimer3int$Timer3_semaphore$0$0({1}SC:U),E,0,0
S:Ftimer3int$Timer3_sem_frequ$0$0({2}SI:U),E,0,0
S:LTimer3_Init$rate$1$1({4}SL:U),E,0,0
S:LTimer3_Init$timing$1$1({2}SI:U),E,0,0
S:LTimer3_Init$sysclock$1$1({4}SL:U),R,0,0,[r2,r3,r4,r5]
S:LTimer3_Init$SFRPAGE_SAVE$1$1({1}SC:S),E,0,0
S:LTimer3_Init$counts$1$1({4}SL:S),R,0,0,[r2,r3,r4,r5]
S:LTimer3_ISR$sem_cnt$1$1({2}SI:U),E,0,0
...
S:G$button_pressed$0$0({2}DF,SV:S),C,0,0
S:G$InvokeSleepMode$0$0({2}DF,SV:S),C,0,0
S:G$ResetWatchdog$0$0({2}DF,SV:S),C,0,0
