...
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Fmain$semaphore$0$0({1}SC:U),E,0,0
S:Lmain$Pon$1$1({2}SI:S),E,0,0
S:Lmain$Poff$1$1({2}SI:S),E,0,0
S:Lmain$cnt_use$1$1({1}SC:U),R,0,0,[r2]
S:Lmain$cnt_time$1$1({2}SI:U),R,0,0,[r3,r4]
S:Lmain$use_cnt$1$1({1}SC:U),R,0,0,[]
S:Lmain$use_time$1$1({2}SI:U),R,0,0,[]
S:Lmain$led_gr_slow$1$1({1}SC:U),R,0,0,[r5]
S:Lmain$led_gr_fast$1$1({1}SC:U),R,0,0,[r6]
S:Lmain$led_rd_fast$1$1({1}SC:U),R,0,0,[r7]
...
S:G$Timer3_ResetSemaphore$0$0({2}DF,SV:S),C,0,0
S:G$Timer3_GetSemaphore$0$0({2}DF,SC:S),C,0,0
