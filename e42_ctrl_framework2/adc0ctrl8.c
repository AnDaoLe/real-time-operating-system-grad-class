...
static __xdata signed   int  input[9];  // sampled 9 input channels values
static __xdata unsigned char timing=0;  // a crude semaphore 
...
{
    char SFRPAGE_SAVE = SFRPAGE;        // Save Current SFR page
    int counts = sysclock/12/rate;      // Init Timer3 to generate interrupts at a RATE Hz rate.
