...
S:Lmain$cnt_buffer$1$1({1}SC:U),R,0,0,[]
S:Lmain$new_buffer$1$1({1}SC:U),E,0,0
S:Lmain$prev_buffer$1$1({1}SC:U),E,0,0
S:Lmain$ch$1$1({1}SC:U),R,0,0,[]
S:Lmain$avg$3$7({2}SI:U),R,0,0,[r5,r6]
S:Lmain$total_avg$3$7({4}SL:U),E,0,0
S:Lmain$position$3$7({1}SC:U),R,0,0,[r4]
S:Lmain$ch$3$7({1}SC:U),R,0,0,[r4]
S:Lmain$datum$1$1({60}DA30,SI:U),F,0,0
S:Lmain$Buffer$3$7({100}DA100,SC:S),F,0,0
...
S:G$getRecentInput$0$0({2}DF,SI:U),C,0,0
S:G$setNextOutput$0$0({2}DF,SV:S),C,0,0
S:G$is_data_ready$0$0({2}DF,SC:U),C,0,0
S:G$reset_data_ready$0$0({2}DF,SV:S),C,0,0
S:G$ADC0_DACs_Timer3_Init$0$0({2}DF,SV:S),C,0,0
S:G$Timer3_ISR$0$0({2}DF,SV:S),C,0,0
S:G$ADC0_ISR$0$0({2}DF,SV:S),C,0,0
S:G$Timer4_PWM_Init$0$0({2}DF,SV:S),C,0,0
S:G$Timer4_PWM_SetFrequency$0$0({2}DF,SV:S),C,0,0
S:G$Timer4_PWM_SetOn$0$0({2}DF,SV:S),C,0,0
S:G$Timer4_PWM_SetDuty$0$0({2}DF,SV:S),C,0,0
S:G$Timer4_PWM_ISR$0$0({2}DF,SV:S),C,0,0
...
S:G$UART_puts$0$0({2}DF,SV:S),C,0,0
S:G$UART_gets$0$0({2}DF,SV:S),C,0,0
S:G$UART_gets_noecho$0$0({2}DF,SV:S),C,0,0
S:G$UART_write$0$0({2}DF,SV:S),C,0,0
S:G$UART_read$0$0({2}DF,SV:S),C,0,0
...
S:Fmain$_str_0$0$0({74}DA74,SC:S),D,0,0
