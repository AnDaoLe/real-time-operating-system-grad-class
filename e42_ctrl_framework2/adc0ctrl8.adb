M:adc0ctrl8
F:G$getRecentInput$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$setNextOutput$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$is_data_ready$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$reset_data_ready$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ADC0_DACs_Timer3_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer3_ISR$0$0({2}DF,SV:S),Z,0,0,1,14,0
F:G$ADC0_ISR$0$0({2}DF,SV:S),Z,0,0,1,15,3
S:LADC0_DACs_Timer3_Init$rate$1$1({4}SL:U),E,0,0
S:LADC0_DACs_Timer3_Init$sysclock$1$1({4}SL:U),R,0,0,[r2,r3,r4,r5]
S:LADC0_DACs_Timer3_Init$SFRPAGE_SAVE$1$1({1}SC:S),E,0,0
S:LADC0_DACs_Timer3_Init$counts$1$1({2}SI:S),R,0,0,[r6,r7]
S:Fadc0ctrl8$input$0$0({18}DA9,SI:S),F,0,0
S:Fadc0ctrl8$timing$0$0({1}SC:U),F,0,0
...
S:Fadc0ctrl8$__xinit_timing$0$0({1}SC:U),C,0,0
