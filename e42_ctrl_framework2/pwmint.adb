M:pwmint
F:G$Timer4_PWM_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer4_PWM_SetFrequency$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer4_PWM_SetOn$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer4_PWM_SetDuty$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer4_PWM_ISR$0$0({2}DF,SV:S),Z,0,0,1,16,3
F:G$Timer4_PWM_ISR$0$0({2}DF,SV:S),Z,0,0,1,16,3
F:G$Timer4_PWM_ISR$0$0({2}DF,SV:S),Z,0,0,1,16,3
F:G$Timer4_PWM_ISR$0$0({2}DF,SV:S),Z,0,0,1,16,3
F:G$Timer4_PWM_ISR$0$0({2}DF,SV:S),Z,0,0,1,16,3
F:G$Timer4_PWM_ISR$0$0({2}DF,SV:S),Z,0,0,1,16,3
F:G$Timer4_PWM_ISR$0$0({2}DF,SV:S),Z,0,0,1,16,3
S:G$sampling$0$0({2}SI:U),E,0,0
S:G$frequency$0$0({2}SI:U),E,0,0
S:G$phase_add$0$0({2}SI:U),E,0,0
S:G$output_waveform$0$0({6}DA6,SC:U),E,0,0
S:G$dutycount$0$0({12}DA6,SI:U),E,0,0
S:LTimer4_PWM_Init$rate$1$1({4}SL:U),E,0,0
S:LTimer4_PWM_Init$sysclock$1$1({4}SL:U),R,0,0,[r2,r3,r4,r5]
S:LTimer4_PWM_Init$SFRPAGE_SAVE$1$1({1}SC:S),E,0,0
S:LTimer4_PWM_Init$counts$1$1({4}SL:S),R,0,0,[r2,r3,r4,r5]
S:LTimer4_PWM_SetFrequency$newfrequency$1$1({4}SL:U),R,0,0,[r2,r3,r4,r5]
S:LTimer4_PWM_SetDuty$newduty$1$1({1}SC:U),E,0,0
S:LTimer4_PWM_SetDuty$channel$1$1({1}SC:U),R,0,0,[r2]
S:LTimer4_PWM_ISR$phase_acc$1$1({2}SI:U),E,0,0
S:LTimer4_PWM_SetFrequency$EA_SAVE$1$1({1}SB0$1:U),H,0,0
S:LTimer4_PWM_SetOn$EA_SAVE$1$1({1}SB0$1:U),H,0,0
S:LTimer4_PWM_SetDuty$EA_SAVE$1$1({1}SB0$1:U),H,0,0
...
S:G$PWMout0$0$0({1}SX:U),J,0,0
S:G$PWMout1$0$0({1}SX:U),J,0,0
S:G$PWMout2$0$0({1}SX:U),J,0,0
S:G$PWMout3$0$0({1}SX:U),J,0,0
S:G$PWMout4$0$0({1}SX:U),J,0,0
S:G$PWMout5$0$0({1}SX:U),J,0,0
