M:bu_flash
F:G$FLASH_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FLASH_erase$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FLASH_put$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FLASH_get$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$getTouch$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$putTouch$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ifFirstTime$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$setNotFirstTime$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$setNotFirstTime$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$setNotFirstTime$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Fbu_flash$ptr_flash_scratchpad$0$0({2}DX,SC:U),E,0,0
S:Fbu_flash$ptr_first_time$0$0({2}DX,SC:U),E,0,0
S:LFLASH_erase$EA_SAVE$1$1({1}SB0$1:U),H,0,0
S:LFLASH_put$EA_SAVE$1$1({1}SB0$1:U),H,0,0
S:LFLASH_get$EA_SAVE$1$1({1}SB0$1:U),H,0,0
S:LputTouch$EA_SAVE$1$1({1}SB0$1:U),H,0,0
...
S:Fbu_flash$flash_scratchpad$0$0({256}DA256,SC:U),D,0,0
S:Fbu_flash$first_time$0$0({1}SC:U),D,0,0
