...
T:Fmain$CONFIG[({0}S:S$count$1$1({2}SI:U),Z,0,0)({2}S:S$name$1$1({30}DA30,SC:S),Z,0,0)({32}S:S$ans$1$1({1}SC:S),Z,0,0)]
S:Lmain$state$1$1({1}SC:U),E,0,0
S:Lmain$ans$1$1({4}DA4,SC:S),E,0,0
S:Lmain$DATA$1$1({33}STCONFIG:S),F,0,0
S:Lmain$buffer$1$1({30}DA30,SC:S),F,0,0
S:Lmain$buffer1$1$1({6}DA6,SC:S),F,0,0
...
S:G$FLASH_Init$0$0({2}DF,SV:S),C,0,0
S:G$FLASH_erase$0$0({2}DF,SV:S),C,0,0
S:G$FLASH_put$0$0({2}DF,SV:S),C,0,0
S:G$FLASH_get$0$0({2}DF,SV:S),C,0,0
S:G$getTouch$0$0({2}DF,SC:U),C,0,0
S:G$putTouch$0$0({2}DF,SV:S),C,0,0
S:G$ifFirstTime$0$0({2}DF,SC:U),C,0,0
S:G$setNotFirstTime$0$0({2}DF,SV:S),C,0,0
...
S:Fmain$_str_0$0$0({20}DA20,SC:S),D,0,0
S:Fmain$_str_1$0$0({16}DA16,SC:S),D,0,0
S:Fmain$_str_2$0$0({9}DA9,SC:S),D,0,0
S:Fmain$_str_3$0$0({15}DA15,SC:S),D,0,0
S:Fmain$_str_4$0$0({3}DA3,SC:S),D,0,0
S:Fmain$_str_5$0$0({9}DA9,SC:S),D,0,0
