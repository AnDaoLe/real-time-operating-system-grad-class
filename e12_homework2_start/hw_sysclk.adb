M:hw_sysclk
F:G$get_sysclk_mode$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$reinit_sysclk$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$reinit_sysclk$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Fhw_sysclk$_sysclk_mode$0$0({1}SC:U),E,0,0
S:Lreinit_sysclk$EA_SAVE$1$1({1}SB0$1:U),H,0,0
