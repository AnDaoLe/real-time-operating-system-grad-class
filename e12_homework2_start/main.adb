M:main
F:G$wait_ms$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lmain$mode$1$1({1}SC:U),R,0,0,[r2]
...
S:G$reinit_sysclk$0$0({2}DF,SV:S),C,0,0
S:G$get_sysclk_mode$0$0({2}DF,SC:U),C,0,0
S:G$wait_ms$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$array_test_sequences$0$0({26}DA13,SI:S),D,0,0
